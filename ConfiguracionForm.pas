...
begin
  Edit24.Text:=Inputbox('Cambiar Longitud máxima cliente ','Introduzca el tamaño del codigo del cliente','15');
end;

procedure TFormConfiguracion.Edit25DblClick(Sender: TObject);
begin
  Edit25.Text:=Inputbox('Cambiar Longitud máxima serie albarán ','Introduzca el tamaño máximo de la serie del albarán','10');
end;

procedure TFormConfiguracion.Edit26DblClick(Sender: TObject);
begin
  Edit26.Text:=Inputbox('Cambiar Longitud máxima número albarán ','Introduzca el tamaño máximo del numero de albarán','10');
end;
