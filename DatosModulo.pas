...
type
  ...
  public
    ...
    Impresora,ImpresoraFra,ImpresoraCopiaFra, NombreFactura : String;
...
begin
  ...
  NombreFactura  :=FicheroINI.ReadString('Internet','Edit29','');
...
begin
  ...
  FicheroINI.WriteString('Internet','Edit29',NombreFactura);
